              ...
              {[
                {
                  ...
                  title: 'Email',
                  content: 'felixcherianuta@gmail.com',
                  link: 'mailto:felixcherianuta@gmail.com'
                },
                {
                  icon: (
                  ...
                  title: 'LinkedIn',
                  content: 'linkedin.com/in/felix-cherian/',
                  link: 'https://www.linkedin.com/in/felix-cherian/'
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  title: 'GitHub',
                  content: 'github.com/Flexinos7',
                  link: 'https://github.com/Flexinos7'
                }
              ].map((contact, index) => (
                <motion.a
                  key={contact.title}
