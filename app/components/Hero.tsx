  ...
  return (
    <section className="relative h-screen overflow-hidden">
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-center max-w-full tracking-tight bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 text-transparent font-semibold mb-4">
          Hello, I&apos;m <br className="block md:hidden" />
          Felix Cherian
        </h1>

        <p className="text-xl md:text-2xl bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 text-transparent mb-4">
          Information Systems Analyst
        </p>

        <p className="text-base sm:text-lg text-white mb-8 max-w-2xl mx-auto text-center">
